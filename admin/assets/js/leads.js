...
document.querySelectorAll(".btn-delete").forEach(botao=>{
    botao.addEventListener("click",function(){
        ...
        fetch("actions/leads/excluir_lead.php",{
            method:"POST",
            headers:{"Content-Type":"application/x-www-form-urlencoded"},
            body:`id=${id}`
        })
...
document.getElementById("btn-fechar-converter")
.addEventListener("click",function(){
...
// ===== CONFIRMAR CONVERSÃO =====
document.getElementById("btn-confirmar-converter")
.addEventListener("click",function(){
    const dados=new URLSearchParams();

    dados.append("lead_id",leadConverterId);
    dados.append("email",document.getElementById("conv-email").value);
    dados.append("telefone",document.getElementById("conv-telefone").value);
    dados.append("instagram",document.getElementById("conv-instagram").value);
    dados.append("cpf",document.getElementById("conv-cpf").value);
    dados.append("servico_id",document.getElementById("conv-servico").value);
    dados.append("sobre",document.getElementById("conv-sobre").value);
    dados.append("proposta_url",document.getElementById("conv-proposta").value);
    dados.append("status_clientes",document.getElementById("conv-status").value);

    fetch("actions/leads/converter_cliente.php",{
        method:"POST",
        headers:{"Content-Type":"application/x-www-form-urlencoded"},
        body:dados.toString()
    })
